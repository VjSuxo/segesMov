...
box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75);
                ...
                <div class="div3">
                    <div class="card" style="width: 20rem;">
                        ...
                        <div class="card-body">
                          ...
                          <p style=" display:none"> {{ $contador= 1 }}</p>
                            @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class=" btn btn-primary" href="{{ route('login') }}">  Inscribete</a>
                                    <a class="  btn btn-primary" href="{{ route('login') }}">  Reserva</a>
                                </li>
    ...
    <p style=" display:none"> {{ $contador= 0 }}</p>
                                        ...
                                        @endif
                                        @if($eventoParticipante->reservado == 1 and $evento->estado != 2)
    <p style=" display:none"> {{ $contador= 0 }}</p>
                                            <li class="nav-item dropdown">
                                            <a href=" {{ route('registro',$evento->id) }} " class=" btn btn-primary">
                                                Inscribirse
                                        </a>
                                            </li>
                                        @endif
                                ...
                                @endforeach
                                @if(empty($eventoParticipante ) || $contador==1 and $evento->estado != 2  )
                                    <li class="nav-item dropdown">
                                        <a href=" {{ route('registro',$evento->id) }} " class="  btn btn-primary">
                                                Inscribirse
                                        </a>
                                        ...
                                        @if( $evento->estado == 0)
                                        <a href=" {{ route('registroR',$evento->id) }} " class="  btn btn-primary">
                                                Reservar
                                        </a>
                                        @endif
                                    </li>
