        ...
        <div class="cuerpo">
            <div class="container text-center">
                ...
                <div class="row align-items-start">
                        ...
                        <div class="col">
                           <form action=" {{ route('controlador.sotreAmbiente2') }} "method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="text" value=" {{ $infraestructuras->id }} " style="display: none " name="infra">
