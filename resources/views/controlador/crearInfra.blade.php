    ...
    <div class="contenedor">
        ...
        <div class="cuerpo">
            <div class="container text-center">
                <div class="titulo">
                    <h1 class="elemento">Crear Infraestrucura</h1>
                </div>
                ...
                <div class="row align-items-start">
                        ...
                        <div class="col">
                            <h1></h1>
                           <form action=" {{ route('controlador.sotreInfra') }} "method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="nombre tema"
                                    id="direccion" name="direccion" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
